...
export default function Nav() {
    ...
    return (
        <>
                ...
                <div className='h-[4rem] top-0 border-b flex justify-between items-center p-8'>
                    <div className='flex gap-10 items-center '>
                        <div className='flex flex-col justify-center items-center'>
                            <p className='luxurious-script-regular text-4xl'>Luxuy</p>
                            <p className='text-[.5rem] relative top-[-.4rem]'>- finest -</p>
                        </div>
                    </div>
            ...
            {
                isHoveringLink && <div className='fixed z-[100] top-[6rem] left-0 right bg-[#FEFEFE] px-8 py-2 border-b w-full shadow-lg'>
